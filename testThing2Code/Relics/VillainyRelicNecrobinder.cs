...
public class VillainyRelicNecrobinder() : testThing2Relic
{
    ...
    public override List<(string, string)> Localization => new PowerLoc(
        "Villainy",
        "#At the start of each turn, Gain [E] and draw [blue]1[/blue] additional card.\n Whenever you play a card, add a [purple]dazed[/purple] to [purple]The Necrobinder[/purple]'s [gold]Draw Pile[/gold].",
        "#At the start of each turn, Gain [E] and draw [blue]1[/blue] additional card.\n Whenever you play a card, add a [purple]dazed[/purple] to [purple]The Necrobinder[/purple]'s [gold]Draw Pile[/gold].");
